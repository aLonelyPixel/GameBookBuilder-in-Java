...
public class GameBookValidator {
	...
	public String validate(GameBookInterface gamebook) {
	 ...
	 */
	public Set<Integer> getUnreferencedParagraphs(GameBookInterface gamebook) {
	 ...
	 */
	private void collectReferencedParagraphs(GameBookInterface gamebook, Set<Integer> isolatedParagraphs, Set<Integer> calledParagraphs) {
	...
	public Set<Integer> getUnreachableParagraphs(GameBookInterface gamebook) {
		...
		unreachableTerminalParagraphs.remove(1);
	 ...
	 */
	private void getAllEndingsFromStart(int startingParagraph, GameBookInterface gamebook, Set<Integer> reachableTerminalParagraphs) {
